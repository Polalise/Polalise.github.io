...
limitation: "개인 담당 범위와 정량 성과가 공개 문서에서 분리되지 않아 기능 전체를 개인 기여로 제시하지 않습니다. 이 페이지는 저장소에서 확인되는 팀 프로젝트의 구조만 요약합니다."
metrics: []
links:
...
현재 공개 근거만으로는 각 기능의 개인 담당자를 구분할 수 없습니다. 따라서 이 페이지는 팀 서비스의 구조와 사용 기술만 설명하며, 특정 기능을 개인이 주도했다는 표현이나 정량 성과를 사용하지 않습니다.
